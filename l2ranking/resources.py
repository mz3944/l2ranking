#l2ranking/l2ranking/resources.py
...
class NewsResource(ModelResource):
    class Meta:
        queryset = frontend_models.News.objects.all().order_by('-vote_count')
        resource_name = 'news'
...
class ReviewResource(ModelResource):
    ...
    class Meta:
        queryset = frontend_models.Review.objects.all().order_by('-create_date')
